...
"""
This is a multiprocessing SNMP network visualizer
This makes a asynchronous SNMP-scan of network with first router
Syntax Python2.6
"""
import netsnmp
...
def main():
    """Runs everything"""
    #clients
    hosts = ["cv-sw1", "df-sw1", "cv-sw1", "df-sw1", "cv-sw1"]
